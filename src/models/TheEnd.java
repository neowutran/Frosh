    ...
    public void run() {
        ...
        while (!FroshController.getInstance().getGridModel().hasEnded()) {
            try {
                ...
                // Ce catch est juste la pour ne pas propager cette exception
                // dont je me fout eperdument
            }
            ...
            while (FroshController.getInstance().getStop()) {
                try {
                    ...
                    // Ce catch est juste la pour ne pas propager cette
                    // exception dont je me fout eperdument
                }
            }
